...
if os.path.exists('../../data/pretrain_model'):
    pretrained_model = {'resnet50' : '../../data/pretrain_model/resnet50-19c8e357.pth',
...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'butterfly':
            ...
            self.buff_drop2 = args.buff_drop2
            if self.buff_drop2:
                self.numcls = 5419 - 2
            else:
                self.numcls = 5419
        ...
        if args.dataset == 'CUB':
            ...
            self.anno_root = '../../data/CUB_200_2011/anno'
            self.numcls = 200
